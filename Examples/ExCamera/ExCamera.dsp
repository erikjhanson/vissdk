...
!MESSAGE 
!MESSAGE NMAKE /f "ExCamera.mak" CFG="ExCamera - Win32 Debug"
!MESSAGE 
...
# ADD LINK32 winmm.lib /nologo /subsystem:windows /machine:I386 /nodefaultlib:"nafxcw.lib"
...
# ADD LINK32 winmm.lib /nologo /subsystem:windows /incremental:no /debug /machine:I386 /nodefaultlib:"nafxcw.lib" /out:"..\..\bin/ExCameraDB.exe"
