...
#define VIS_DECLARE_SDI_FIND_TYPES(Storage, TObject)			\
...
#define VIS_DECLARE_SDI_FIND_TYPES_DEFAULT(Storage, TObject)\
	VIS_DECLARE_SDI_FIND_TYPES(Storage, TObject)
...
#define VIS_DECLARE_SDI_READ_VALUE(Storage, TObject)		\
...
#define VIS_DECLARE_SDI_READ_VALUE_USING_CLASS_METHOD(Storage, TObject)	\
	VIS_DECLARE_SDI_READ_VALUE(Storage, TObject)
