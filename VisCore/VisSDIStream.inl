...
inline CVisSDIStream& operator>>(CVisSDIStream& refsdistream,
		std::vector<TObject>& refvector)
{
	VisSDReadObj(refsdistream, refvector);
	return refsdistream;
}
		...
		CVisArray<TObject> const& refarray)
{
	if (refarray.empty())
		...
		VisSDIFindTypes(refsdistream, refarray.front());
		...
		CVisArray<TObject>& refarray)
{
	...
	while (!refsdistream.AtEndOfGroup())
	{
		refarray.push_back(TObject());
		VisSDReadValue(refsdistream, refarray.back());
	}
...
inline void VisSDReadObj(CVisSDIStream& refsdistream,
		CVisArray<TObject>& refarray)
{
	VisSDIFindTypes(refsdistream, refarray);

	refsdistream.StartObj(refarray);
	VisSDReadValue(refsdistream, refarray);
	refsdistream.EndObj();
}
...
inline CVisSDIStream& operator>>(CVisSDIStream& refsdistream,
		CVisArray<TObject>& refarray)
{
	VisSDReadObj(refsdistream, refarray);
	return refsdistream;
}
...
{
	if (reftable.empty())
		VisSDIFindTypes(refsdistream, CVisArray<TObject>());
	else
		VisSDIFindTypes(refsdistream, reftable.front());
		...
		CVisTable<TObject>& reftable)
{
	...
	while (!refsdistream.AtEndOfGroup())
	{
		reftable.push_back(CVisArray<TObject>());
		VisSDReadValue(refsdistream, reftable.back());
	}
...
inline void VisSDReadObj(CVisSDIStream& refsdistream,
		CVisTable<TObject>& reftable)
{
	VisSDIFindTypes(refsdistream, reftable);

	refsdistream.StartObj(reftable);
	VisSDReadValue(refsdistream, reftable);
	refsdistream.EndObj();
}
...
inline CVisSDIStream& operator>>(CVisSDIStream& refsdistream,
		CVisTable<TObject>& reftable)
{
	VisSDReadObj(refsdistream, reftable);
	return refsdistream;
}
