...
// Use "VIS_" prefix here to avoid multiple definitions when we link.
const IID VIS_IID_IIPDVDec = { 0xb8e8bd60, 0x0bfe, 0x11d0, 0xaf, 0x91, 0x00, 0xaa, 0x00, 0xb6, 0x7a, 0x42 };
...
{ 
    ...
    {        
        ...
        VIS_STRM_GTHR( pDVVidDecoder->QueryInterface( VIS_IID_IIPDVDec,
				(void**)&pIIPDVDec ), "QI for IIPDVDec failed" );
