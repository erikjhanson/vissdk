...
// LATER:  Use templated helper functions to avoid duplicating code for each
// container type.
...
template<class TObject>
inline void VisSDOFindTypes(CVisSDOStream& refsdostream,
		CVisArray<TObject> const& refarray)
{
	if (refarray.empty())
		VisSDOFindTypes(refsdostream, TObject());
	else
		VisSDOFindTypes(refsdostream, refarray.front());

	CVisPropTypeInfoBase *pproptypeinfo = VisGetPropTypeInfo(refarray);
...
{
	assert(VisPPropTypeInfoForClass(TObject()) != 0);
	bool fUseNewLines = ((!refarray.empty())
			&& (!VisPPropTypeInfoForClass(refarray.front())->IsSimpleType()));
	refsdostream.OpenGroup(fUseNewLines);

	const CVisArray<TObject>::const_iterator iteratorLim = refarray.end();
	CVisArray<TObject>::const_iterator iteratorCur = refarray.begin();
	for (; iteratorCur != iteratorLim; ++iteratorCur)
	{
		VisSDWriteValue(refsdostream, *iteratorCur);
		if (fUseNewLines)
...
template<class TObject>
inline void VisSDWriteObj(CVisSDOStream& refsdostream,
		CVisArray<TObject> const& refarray, const char *szName)
{
	VisSDOFindTypes(refsdostream, refarray);

	refsdostream.StartObj(refarray, szName);
	VisSDWriteValue(refsdostream, refarray);
	refsdostream.EndObj();
}
...
inline CVisSDOStream& operator<<(CVisSDOStream& refsdostream,
		CVisArray<TObject> const& refarray)
{
	VisSDWriteObj(refsdostream, refarray, 0);
	return refsdostream;
}
...
template<class TObject>
inline void VisSDOFindTypes(CVisSDOStream& refsdostream,
		CVisArray<TObject>& refarray)
{
	VisSDOFindTypes(refsdostream, (CVisArray<TObject> const &) refarray);
}
...
inline void VisSDWriteValue(CVisSDOStream& refsdostream,
		CVisArray<TObject>& refarray)
{
	VisSDWriteValue(refsdostream, (CVisArray<TObject> const &) refarray);
}

template<class TObject>
inline void VisSDWriteObj(CVisSDOStream& refsdostream,
		CVisArray<TObject>& refarray, const char *szName)
{
	VisSDWriteObj(refsdostream, (CVisArray<TObject> const &) refarray);
}
...
inline CVisSDOStream& operator<<(CVisSDOStream& refsdostream,
		CVisArray<TObject>& refarray)
{
	return operator<<(refsdostream, (CVisArray<TObject> const &) refarray);
}
...
template<class TObject>
inline void VisSDOFindTypes(CVisSDOStream& refsdostream,
		CVisTable<TObject> const& reftable)
{
	if (reftable.empty())
		VisSDOFindTypes(refsdostream, CVisArray<TObject>());
	else
		VisSDOFindTypes(refsdostream, reftable.front());

	CVisPropTypeInfoBase *pproptypeinfo = VisGetPropTypeInfo(reftable);
...
{
	assert(VisPPropTypeInfoForClass(TObject()) != 0);
	bool fUseNewLines = ((!reftable.empty())
			&& (!VisPPropTypeInfoForClass(reftable.front())->IsSimpleType()));
	refsdostream.OpenGroup(fUseNewLines);

	const CVisTable<TObject>::const_iterator iteratorLim = reftable.end();
	CVisTable<TObject>::const_iterator iteratorCur = reftable.begin();
	for (; iteratorCur != iteratorLim; ++iteratorCur)
	{
		VisSDWriteValue(refsdostream, *iteratorCur);
		if (fUseNewLines)
...
template<class TObject>
inline void VisSDWriteObj(CVisSDOStream& refsdostream,
		CVisTable<TObject> const& reftable, const char *szName)
{
	VisSDOFindTypes(refsdostream, reftable);

	refsdostream.StartObj(reftable, szName);
	VisSDWriteValue(refsdostream, reftable);
	refsdostream.EndObj();
}
...
inline CVisSDOStream& operator<<(CVisSDOStream& refsdostream,
		CVisTable<TObject> const& reftable)
{
	VisSDWriteObj(refsdostream, reftable, 0);
	return refsdostream;
}
...
template<class TObject>
inline void VisSDOFindTypes(CVisSDOStream& refsdostream,
		CVisTable<TObject>& reftable)
{
	VisSDOFindTypes(refsdostream, (CVisTable<TObject> const &) reftable);
}
...
inline void VisSDWriteValue(CVisSDOStream& refsdostream,
		CVisTable<TObject>& reftable)
{
	VisSDWriteValue(refsdostream, (CVisTable<TObject> const &) reftable);
}

template<class TObject>
inline void VisSDWriteObj(CVisSDOStream& refsdostream,
		CVisTable<TObject>& reftable, const char *szName)
{
	VisSDWriteObj(refsdostream, (CVisTable<TObject> const &) reftable);
}
...
inline CVisSDOStream& operator<<(CVisSDOStream& refsdostream,
		CVisTable<TObject>& reftable)
{
	return operator<<(refsdostream, (CVisTable<TObject> const &) reftable);
}
