...
#define VIS_DECLARE_SDO_FIND_TYPES(Storage, TObject)			\
...
#define VIS_DECLARE_SDO_FIND_TYPES_DEFAULT(Storage, TObject)	\
	VIS_DECLARE_SDO_FIND_TYPES(Storage, TObject);
...
#define VIS_DECLARE_SDO_WRITE_VALUE(Storage, TObject)			\
...
#define VIS_DECLARE_SDO_WRITE_VALUE_USING_CLASS_METHOD(Storage, TObject)\
	VIS_DECLARE_SDO_WRITE_VALUE(Storage, TObject)
...
#define VIS_DECLARE_SDO_WRITE_OBJ(Storage, TObject)			\
