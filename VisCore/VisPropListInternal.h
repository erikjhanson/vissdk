...
template<class TObject>
class CVisPropTypeInfoArray : public CVisPropTypeInfoWithIO<TObject>
{
public:
	CVisPropTypeInfoArray(void);
	virtual ~CVisPropTypeInfoArray(void);
};


template<class TObject>
class CVisPropTypeInfoTable : public CVisPropTypeInfoWithIO<TObject>
{
public:
	CVisPropTypeInfoTable(void);
	virtual ~CVisPropTypeInfoTable(void);
};
