...
template<class TObject>
inline void VisSetPropTypeInfoArrayName(
		CVisPropTypeInfoArray<CVisArray<TObject> >&refproptypeinfo)
{
	std::string strTypeIOName("vector<");
	strTypeIOName += VisGetPropTypeInfo(TObject())->Name();
	strTypeIOName += ">";
...
template<class TObject>
inline CVisPropTypeInfoArray<TObject>::CVisPropTypeInfoArray(
		void)
  : CVisPropTypeInfoWithIO<TObject>()
{
	VisSetPropTypeInfoArrayName(*this);
}
...
template<class TObject>
inline void VisSetPropTypeInfoTableName(
		CVisPropTypeInfoTable<CVisTable<TObject> >&refproptypeinfo)
{
	std::string strTypeIOName("vector<vector<");
	strTypeIOName += VisGetPropTypeInfo(TObject())->Name();
	strTypeIOName += ">>";
	refproptypeinfo.SetName(strTypeIOName.c_str());
}
...
template<class TObject>
inline CVisPropTypeInfoTable<TObject>::CVisPropTypeInfoTable(
		void)
  : CVisPropTypeInfoWithIO<TObject>()
{
	VisSetPropTypeInfoTableName(*this);
}
...
#define VIS_DECLARE_PROP_LIST_CLASS_TYPE_INFO_ARRAY(Storage, TObject)	\
	Storage CVisPropTypeInfoBase *VisPPropTypeInfoNewForClass(			\
			TObject const &refobj);

#define VIS_DECLARE_PROP_LIST_CLASS_TYPE_INFO_TABLE(Storage, TObject)	\
	Storage CVisPropTypeInfoBase *VisPPropTypeInfoNewForClass(			\
			TObject const &refobj);
...
#define VIS_DEFINE_PROP_LIST_CLASS_TYPE_INFO_ARRAY(Storage, TObject)	\
	Storage CVisPropTypeInfoBase *VisPPropTypeInfoNewForClass(			\
			TObject const &refobj)										\
		{ return new CVisPropTypeInfoArray<TObject >; }

#define VIS_DEFINE_PROP_LIST_CLASS_TYPE_INFO_TABLE(Storage, TObject)	\
	Storage CVisPropTypeInfoBase *VisPPropTypeInfoNewForClass(			\
			TObject const &refobj)										\
		{ return new CVisPropTypeInfoTable<TObject >; }
...
#define VIS_PROP_LIST_CLASS_TYPE_INFO_ARRAY(TObject)	\
	VIS_DEFINE_PROP_LIST_CLASS_TYPE_INFO_ARRAY(inline, TObject)

#define VIS_PROP_LIST_CLASS_TYPE_INFO_TABLE(TObject)	\
	VIS_DEFINE_PROP_LIST_CLASS_TYPE_INFO_TABLE(inline, TObject)
...
#define VIS_DECLARE_PROP_LIST_CLASS_ARRAY(Storage, TObject)						\
	VIS_DECLARE_PROP_LIST_CLASS_TYPE_INFO_ARRAY(Storage, CVisArray<TObject >)	\
	VIS_DECLARE_PROP_LIST_CLASS_TYPE_INFO_LOOKUP(Storage, CVisArray<TObject >)	\
	VIS_DECLARE_PROP_LIST_GET_PROP_TYPE_INFO(Storage, CVisArray<TObject >)

#define VIS_DECLARE_PROP_LIST_CLASS_TABLE(Storage, TObject)						\
	VIS_DECLARE_PROP_LIST_CLASS_TYPE_INFO_TABLE(Storage, CVisTable<TObject >)	\
	VIS_DECLARE_PROP_LIST_CLASS_TYPE_INFO_LOOKUP(Storage, CVisTable<TObject >)	\
	VIS_DECLARE_PROP_LIST_GET_PROP_TYPE_INFO(Storage, CVisTable<TObject >)

#define VIS_DECLARE_PROP_LIST_CLASS_AV(Storage, TObject)\
	VIS_DECLARE_PROP_LIST_CLASS_ARRAY(Storage, TObject)	\
	VIS_DECLARE_PROP_LIST_CLASS_VECTOR(Storage, TObject)

#define VIS_DECLARE_PROP_LIST_CLASS_AVT(Storage, TObject)	\
	VIS_DECLARE_PROP_LIST_CLASS_AV(Storage, TObject)		\
	VIS_DECLARE_PROP_LIST_CLASS_TABLE(Storage, TObject)	
...
#define VIS_DEFINE_PROP_LIST_CLASS_ARRAY(Storage, TObject)						\
	VIS_DEFINE_PROP_LIST_CLASS_TYPE_INFO_ARRAY(Storage, CVisArray<TObject >)	\
	VIS_DEFINE_PROP_LIST_CLASS_TYPE_INFO_LOOKUP(Storage, CVisArray<TObject >)	\
	VIS_DEFINE_PROP_LIST_GET_PROP_TYPE_INFO(Storage, CVisArray<TObject >)

#define VIS_DEFINE_PROP_LIST_CLASS_TABLE(Storage, TObject)						\
	VIS_DEFINE_PROP_LIST_CLASS_TYPE_INFO_TABLE(Storage, CVisTable<TObject >)	\
	VIS_DEFINE_PROP_LIST_CLASS_TYPE_INFO_LOOKUP(Storage, CVisTable<TObject >)	\
	VIS_DEFINE_PROP_LIST_GET_PROP_TYPE_INFO(Storage, CVisTable<TObject >)

#define VIS_DEFINE_PROP_LIST_CLASS_AV(Storage, TObject)	\
	VIS_DEFINE_PROP_LIST_CLASS_ARRAY(Storage, TObject)	\
	VIS_DEFINE_PROP_LIST_CLASS_VECTOR(Storage, TObject)	

#define VIS_DEFINE_PROP_LIST_CLASS_AVT(Storage, TObject)\
	VIS_DEFINE_PROP_LIST_CLASS_AV(Storage, TObject)		\
	VIS_DEFINE_PROP_LIST_CLASS_TABLE(Storage, TObject)
...
#define VIS_PROP_LIST_CLASS_ARRAY(TObject)	\
	VIS_DEFINE_PROP_LIST_CLASS_ARRAY(inline, TObject)	

#define VIS_PROP_LIST_CLASS_TABLE(TObject)	\
	VIS_DEFINE_PROP_LIST_CLASS_TABLE(inline, TObject)	

#define VIS_PROP_LIST_CLASS_AV(TObject)	\
	VIS_PROP_LIST_CLASS_ARRAY(TObject)	\
	VIS_PROP_LIST_CLASS_VECTOR(TObject)	

#define VIS_PROP_LIST_CLASS_AVT(TObject)\
	VIS_PROP_LIST_CLASS_AV(TObject)		\
	VIS_PROP_LIST_CLASS_TABLE(TObject)
