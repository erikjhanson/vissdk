...
// WARNING:  This operator is provided to dump the contents of an image to
// stdout for debugging.  It should not be used to store images in text files.
static inline void pixel_out(std::ostream& os, CVisRGBA<int>& p)
{
    os << "(" << int(p.R()) << ", " << int(p.G()) << ", "
			<< int(p.B()) << ", " << int(p.A()) << ")";
}
...
// WARNING:  This operator is provided to dump the contents of an image to
// stdout for debugging.  It should not be used to store images in text files.
static inline void pixel_out(std::ostream& os, CVisRGBA<float>& p)
{
    os << "(" << p.R() << ", " << p.G() << ", "
			  << p.B() << ", " << p.A() << ")";
}
...
// WARNING:  This operator is provided to dump the contents of an image to
// stdout for debugging.  It should not be used to store images in text files.
static inline void pixel_out(std::ostream& os, float& p)
{
    os << p;
}
